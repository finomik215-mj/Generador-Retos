...
6. **Seqüenciar.** Els blocs van SEMPRE en l'ordre de l'estructura (no els barregis); dins de cada bloc, ordena els objectius per dependències i per l'arc. Desempat: "àncora concreta primer" quan competeixen abstracte i concret. Ajusta el gra per càrrega cognitiva (parteix si demana sostenir massa idees noves alhora). Cuida la varietat d'estratègia.
...
- Copia els noms de "bloque" i "subtema" EXACTAMENT com apareixen a l'estructura que et dono: mateixos caràcters i mateix idioma (encara que estiguin en castellà i tu escriguis la resta en català). Són identificadors: no els tradueixis, ni els retoquis, ni corregeixis cap accent. Han de coincidir caràcter per caràcter.
- Respecta l'ORDRE dels blocs de l'estructura. La seqüència d'objectius ha de recórrer els blocs en el MATEIX ordre en què te'ls dono: primer tots els objectius del primer bloc, després els del segon, etc. Si creus que un altre ordre seria millor, digues-ho a "recomendacionesEstructura", però NO reordenis els blocs a la seqüència.
